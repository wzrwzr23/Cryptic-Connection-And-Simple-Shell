                ...
                while True:
                    match convert_bytes_to_int(read_bytes(client_socket, 8)):
                        ...
                        case 2:
                            ...
                            # Python context used here so no need1 to explicitly close the socket
                        ...
                        case 3:
                            ...
                            s.sendall(message)
                            with open("auth/server_signed.crt", mode="rb") as serversigned:
                                server_signed = serversigned.read()

                                s.sendall(convert_int_to_bytes(len(server_signed)))
                                s.sendall(server_signed)
